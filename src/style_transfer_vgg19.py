...
def run_style_transfer(content_path,style_path,output_path,epochs=10,steps_per_epoch=100,style_weight=1e-2,content_weight=1e4,total_variation_weight=30,learning_rate=0.02,max_dim=512,):
...
def main():
    ...
    run_style_transfer(args.content,args.style,args.output,epochs=args.epochs,steps_per_epoch=args.steps_per_epoch,style_weight=args.style_weight,content_weight=args.content_weight,total_variation_weight=args.tv_weight,learning_rate=args.lr,max_dim=args.max_dim,)
